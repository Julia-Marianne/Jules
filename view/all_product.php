...
if (loggedIn() == false){
  ...
  if (isset($_SESSION['name']) && $_SESSION['userRole'] == '2') {	
    ...
    <button type="button" onclick = "document.location= 'home.php'"><b>Home</b></button>
...
<!-- <div class="container">
  ...
  <tr>
    <td> <?php $catName = select_all_categories_ctr($showproduct['product_cat']); echo $catName['cat_name'];?></td>
    <td> <?php $brandName = get_record_by_brand_ctr($showproduct['product_brand']);echo $brandName['brand_name'];?></td>
